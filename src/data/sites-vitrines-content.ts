...
export const differentiateurs: DifferentiateurCard[] = [
  {
    ...
    text: "Design, code, contenu, SEO, l\u2019IA propulse chaque étape. Pas pour remplacer l\u2019humain. Pour amplifier 25 ans d\u2019expertise. Résultat : 72h au lieu de 6 semaines.",
    accent: "orange",
  },
  {
    icon: "Hammer",
    title: "25 ans de craft web",
    text: "Fabien a forgé des centaines de sites. Il sait ce qui convertit, ce qui dure, ce qui illumine un business. L\u2019IA est un outil. L\u2019\u0153il, c\u2019est 25 ans d\u2019expérience.",
    accent: "amber",
...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Oui. On propose aussi la cr\u00E9ation d\u2019identit\u00E9 visuelle compl\u00E8te\u202F: logo, charte graphique, univers de marque. 25 ans de direction cr\u00E9ative derri\u00E8re chaque projet. D\u00E9couvrez notre offre identit\u00E9 visuelle.",
    link: {
