...
export const agenceStory = {
  ...
  subtitle: "25 ans de constat, 6 mois de R&D, une seule conviction.",
  paragraphs: [
    {
      label: "Le constat",
...
export const agenceTeamSection = {
  ...
  subtitle: "25 ans de craft web, l'IA comme superpouvoir, et une ingénierie sans compromis.",
};
