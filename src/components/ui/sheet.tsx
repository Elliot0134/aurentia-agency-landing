...
function SheetOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-black/30 supports-backdrop-filter:backdrop-blur-sm transition-opacity duration-500 ease-in-out data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className,
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          "fixed z-50 flex flex-col gap-6 bg-background p-6 text-foreground shadow-xl ring-1 ring-foreground/10 outline-none transition-transform duration-500 ease-in-out",
          sideClasses[side],
          className,
        )}
        {...props}
