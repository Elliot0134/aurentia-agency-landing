...
import { ArrowRight, GraduationCap, BookOpen, Check } from "lucide-react";
import { Section } from "@/components/ui/Section";
import { SpotlightCard } from "@/components/animations/SpotlightCard";
import { BlurReveal } from "@/components/animations/BlurReveal";
import { TextReveal } from "@/components/animations/TextReveal";

export function Skills20CTA() {
  ...
  return (
    <Section theme="dark" className="relative overflow-hidden">
      {/* Glow */}
      <div className="absolute bottom-[-10%] left-1/2 -translate-x-1/2 w-[60%] aspect-[3/1] rounded-full pointer-events-none"
        ...
        <BlurReveal className="w-full grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <SpotlightCard className="p-6 flex flex-col gap-4">
            <div className="relative z-10 flex items-start gap-3">
              ...
              <div>
                ...
                <h3 className="font-black text-foreground/90 text-lg leading-tight">
                  Formation Claude AI
                </h3>
              </div>
            </div>
            <p className="relative z-10 text-sm text-foreground/50 leading-relaxed">
              Modules vidéo, exercices pratiques et accompagnement. De débutant à expert Claude AI en quelques semaines.
            </p>
            <a
              href="/formation"
          ...
          <SpotlightCard className="p-6 flex flex-col gap-4">
            <div className="relative z-10 flex items-start gap-3">
              ...
              <div>
                <p className="text-xs text-blue-400 font-mono tracking-widest uppercase mb-0.5">
                  Guide gratuit
                </p>
                <h3 className="font-black text-foreground/90 text-lg leading-tight">
                  Maîtrisez Claude en 30 min
                </h3>
              </div>
            </div>
            <p className="relative z-10 text-sm text-foreground/50 leading-relaxed">
              5 chapitres, 10 prompts prêts à l&apos;emploi, les 5 règles d&apos;or du prompting. Zéro prérequis.
            </p>
            <a
              href="/formation/guide-demarrage-claude"
          ...
          <div className="rounded-2xl border border-foreground/10 bg-foreground/[0.03] p-6 flex flex-col gap-4">
            <div>
              ...
              <p className="text-sm text-foreground/40 mt-1">
                Nouveaux skills, tips Claude AI et actualités Aurentia — directement dans votre boîte.
              </p>
            </div>
