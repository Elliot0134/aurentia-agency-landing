...
import { formationFAQs } from "@/data/formation-content";
  ...
  return (
    ...
    >
      <button
        ...
        aria-controls={`formation-faq-answer-${index}`}
        id={`formation-faq-question-${index}`}
        className={cn(
      ...
      <div
        id={`formation-faq-answer-${index}`}
        role="region"
        aria-labelledby={`formation-faq-question-${index}`}
        className={cn(
...
export function FormationFAQ() {
  ...
  return (
    <Section theme="dark-alt-2" className="py-24 md:py-32">
      {/* Ambient glow */}
      <div
        aria-hidden="true"
