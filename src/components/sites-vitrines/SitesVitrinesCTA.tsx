...
export function SitesVitrinesCTA() {
  ...
  return (
    ...
    >
      {/* Gradient mesh with orbs */}
      <SectionBackground
        orbs={[
          { color: "orange", position: "bottom-0 left-[20%]", size: "w-[500px] h-[500px]", opacity: "[0.12]" },
          { color: "ambre", position: "top-0 right-[20%]", size: "w-[350px] h-[350px]", opacity: "[0.08]" },
          { color: "orange", position: "bottom-[30%] right-[10%]", size: "w-[250px] h-[250px]", opacity: "[0.06]" },
        ]}
      />
      ...
      >
        ...
        >
          {ctaContent.proofs.map((proof, idx) => (
            ...
            >
              <Check className="w-4 h-4 text-orange-500/70 flex-shrink-0" />
