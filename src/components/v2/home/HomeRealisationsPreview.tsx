  ...
  return (
    <Link href={`/realisations/${proj.slug}`} className="block w-full h-full">
      <SpotlightCard className="w-full h-full p-4 md:p-5 flex flex-col justify-between group overflow-hidden relative cursor-pointer" data-cursor="click">
        ...
        {/* Top gradient — subtle, inverts with theme */}
        ...
        {/* Bottom gradient — subtle, inverts with theme */}
        ...
        {/* Slider controls — on top of phone mockup */}
        {hasMultiple && (
          <>
            <button
              onClick={prev}
        ...
        {/* Name + services (bottom) — text-background inverts with theme */}
