    ...
    <SectionContainer id="equipe" title={title} className="relative">
        ...
        <BlurReveal delay={0.4}>
          <div className="mt-10 flex justify-center">
            <a
              href="/a-propos"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-foreground/10 bg-foreground/[0.04] backdrop-blur-md text-foreground hover:bg-foreground/[0.08] hover:border-foreground/20 transition-all duration-500 ease-in-out font-medium"
            >
              Découvrir l&apos;équipe
