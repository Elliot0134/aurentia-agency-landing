...
export function SurMesureTimeline({
  ...
  return (
    <SectionContainer id="method" title={title} subtitle={subtitle} surface>
      <div
        ref={containerRef}
      ...
      >
        ...
        <div
          aria-hidden
          className="absolute bottom-0 left-6 top-0 w-px bg-foreground/10 md:left-1/2 md:-translate-x-1/2"
        />
        {/* Animated fill on top of the rail */}
        <div
          ref={fillRef}
          aria-hidden
          className="absolute bottom-0 left-6 top-0 w-px origin-top scale-y-0 bg-gradient-to-b from-accent-primary/80 via-accent-primary/60 to-accent-primary/0 md:left-1/2 md:-translate-x-1/2"
        />
                ...
                >
                  ...
                  <div className="md:w-1/2">
                    <BlurReveal delay={idx * 0.05}>
                      <div
                        className={cn(
                          "group relative ml-14 rounded-3xl border border-foreground/10 bg-background p-6 md:ml-0 md:p-8",
                      ...
                      >
                        ...
                        <span
                          aria-hidden
                          className={cn(
                            "pointer-events-none absolute -top-6 select-none font-mono text-6xl font-black leading-none text-accent-primary/10 transition-colors duration-700 ease-in-out group-hover:text-accent-primary/25 md:text-7xl",
                  ...
                  >
                    <div className="relative">
                      <div className="size-4 rounded-full border-2 border-accent-primary bg-background transition-all duration-700 ease-in-out" />
                      <div className="absolute inset-0 size-4 animate-ping rounded-full bg-accent-primary/30 [animation-duration:2.5s]" />
                    </div>
                  </div>
