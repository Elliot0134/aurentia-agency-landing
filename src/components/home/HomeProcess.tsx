  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      <div className="relative flex flex-col items-center pt-3 px-3">
        <div className="w-full max-w-[320px] bg-foreground/[0.04] border border-foreground/[0.08] rounded-2xl overflow-hidden shadow-[0_16px_64px_rgba(0,0,0,0.08)]">
          <div className="flex items-center gap-0 bg-foreground/[0.06] border-b border-foreground/[0.06]">
            ...
            <div className="flex-1 flex">
              <div className="flex items-center gap-1.5 px-3 py-2 bg-foreground/[0.04] border-b-2 border-accent-primary/50 text-sm font-mono text-foreground/40">
        ...
        <div className="absolute bottom-4 right-4 bg-background/60 border border-green-500/15 rounded-xl px-3 py-2 backdrop-blur-md shadow-[0_4px_16px_rgba(0,0,0,0.06)] flex items-center gap-2">
        ...
        <div className="w-full max-w-[300px] space-y-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 bg-gradient-to-br from-accent-primary/[0.06] to-transparent border border-accent-primary/15 rounded-xl px-3.5 py-2.5 backdrop-blur-sm shadow-[0_4px_20px_rgba(201,100,66,0.08)]">
              ...
              <div className="flex gap-1">
                {[1,2,3].map(i => (<div key={i} className="flex-1 h-6 rounded bg-gradient-to-br from-accent-primary/10 to-accent-primary/[0.03] border border-accent-primary/10" />))}
              </div>
            </div>
          </div>
        </div>
    ...
    >
      ...
      <div className="relative z-10 flex flex-col py-16 md:py-0 md:h-screen md:justify-center">
        ...
        <div className="overflow-visible flex items-center">
          <div
            ref={trackRef}
            className="flex flex-col md:flex-row gap-6 px-6 md:gap-6 md:w-max w-full"
          >

            {steps.map((step) => (
              <SpotlightCard
                key={step.num}
                className="process-card w-full md:w-[340px] lg:w-[380px] group shrink-0"
              >
