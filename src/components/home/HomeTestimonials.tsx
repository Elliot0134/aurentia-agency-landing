...
// ---------------------------------------------------------------------------
// Star rating — 5 inline SVG stars
// ---------------------------------------------------------------------------
...
function TestimonialCard({
  ...
  return (
    <div className="relative z-10 flex flex-col gap-6 p-8 h-full rounded-3xl border border-foreground/5 bg-foreground/[0.02] backdrop-blur-sm">
      ...
      <blockquote className="relative flex-1">
        ...
        <span
          className="absolute -top-2 -left-1 text-5xl leading-none text-accent-primary/20 font-heading select-none pointer-events-none"
          aria-hidden="true"
        >
          &ldquo;
        </span>
  ...
  return (
    ...
    >
      ...
      <div className="relative -mx-6 md:-mx-12 overflow-hidden">
        {/* Left shadow */}
        <div className="pointer-events-none absolute inset-y-0 left-0 z-20 w-24 md:w-40 bg-gradient-to-r from-background-alt to-transparent" />
        {/* Right shadow */}
        <div className="pointer-events-none absolute inset-y-0 right-0 z-20 w-24 md:w-40 bg-gradient-to-l from-background-alt to-transparent" />
