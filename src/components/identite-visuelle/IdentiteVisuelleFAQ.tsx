...
import { faqContent, faqItems } from "@/data/identite-visuelle-content";
  ...
  return (
    ...
    >
      <button
        ...
        aria-controls={`iv-faq-answer-${index}`}
        id={`iv-faq-question-${index}`}
        className={cn(
      ...
      {/* Accordion body */}
      <div
        id={`iv-faq-answer-${index}`}
        role="region"
        aria-labelledby={`iv-faq-question-${index}`}
        className={cn(
...
export function IdentiteVisuelleFAQ() {
