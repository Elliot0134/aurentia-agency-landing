...
const services = [
  ...
  { label: "SEO & Référencement", href: "#seo" },
...
export function Navbar() {
  ...
  return (
    <header
      ...
      style={{ paddingTop: scrolled ? "8px" : "16px", transition: "padding-top 0.3s ease" }}
    >
      <nav
      ...
      >
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="hidden md:flex items-center gap-1 flex-1">
            ...
            >
              ...
              {/* Dropdown Menu */}
              <div
                className={`absolute top-full left-0 mt-2 w-52 rounded-xl border overflow-hidden transition-all duration-200 origin-top ${
                  dropdownOpen
            ...
            <Link
              href="#equipe"
              className="px-3 py-1.5 text-sm font-medium text-foreground/70 hover:text-foreground rounded-xl hover:bg-foreground/5 transition-all duration-200"
            >
              L&apos;agence
            </Link>
          </div>
          ...
          <Link href="/" className="flex items-center group shrink-0">
            {mounted && (
              <Image
                ...
                width={200}
                height={80}
                className="h-[42px] w-auto group-hover:opacity-80 transition-opacity duration-200"
                priority
              />
            )}
          </Link>
        ...
        >
          <div className="px-4 py-3 space-y-1">
            {/* Services sub-items */}
            <p className="text-xs font-semibold text-foreground/40 uppercase tracking-wider px-3 pt-1">
              Services
            </p>
            {services.map((service) => (
              <Link
            ...
            <Link
              href="#equipe"
              onClick={() => setMobileOpen(false)}
              className="block px-3 py-2 text-sm font-medium text-foreground/70 hover:text-foreground hover:bg-foreground/5 rounded-lg transition-colors"
            >
              L&apos;agence
            </Link>
