  ...
  return (
    ...
    >
      <button
        ...
        aria-controls={`apport-faq-answer-${index}`}
        id={`apport-faq-question-${index}`}
        className={cn(
      ...
      {/* Accordion body */}
      <div
        id={`apport-faq-answer-${index}`}
        role="region"
        aria-labelledby={`apport-faq-question-${index}`}
        className={cn(
...
export function ApportAffairesFAQ() {
