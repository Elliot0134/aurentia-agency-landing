...
export function LowPolyBookingCTALab() {
  // 4 nuances quasi-jumelles autour du brand. Delta ~3% en luminance.
  // Facettes lisibles à l'œil mais transition très douce, surface qui
  // respire en uni. Graph-coloring garantit zéro voids malgré la finesse.
  const bgShades = ["#DC7B5C", "#D97757", "#D27253", "#CA6C4F"];
