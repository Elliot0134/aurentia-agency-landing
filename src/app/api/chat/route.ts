...
export async function POST(req: Request) {
  ...
  const audienceContext =
    audience === "web"
      ? "Le visiteur a un PROJET WEB (site vitrine, refonte). Insiste sur le craft, le design premium, la livraison 72h et la performance SEO. Pousse-le à prendre contact."
      : audience === "ecommerce"
